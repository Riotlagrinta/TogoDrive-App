...
import { z } from 'zod';
import { Car, User, Mail, Lock, Phone, ArrowRight, Loader2 } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Rejoignez l'aventure et explorez la route en toute liberté.
          </p>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/login" className="font-bold text-togo-green hover:underline decoration-2">
              Connectez-vous
            </Link>
          </p>
        </div>
